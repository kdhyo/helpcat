...
class Aside extends Component {
  render() {
      return (
        <>
      <aside>
        <Link to="/"><div className="asider1"><img className="asiderpng" src="./guide.png" width="px" title="가이드" alt="가이드"></img></div></ Link>
        ...
        <Link to="/"><div className="asider4"><img className="asiderpng" src="./write.png" width="px" title="글쓰기" alt="글쓰기"></img></div></ Link>
      </aside>
    </>
    )
  }
